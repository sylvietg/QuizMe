...
<?php 
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		$_SESSION['sA'] = $_POST['quiz'];
		$_SESSION['sS'] = $_POST['sco'];
...
<?php
$page_title="Quiz me: Subtraction";
// header
include("top.php");
?>
...
<section>
	...
	<form>
		...
		<p>
			<input type = "button" value="Check" onclick = "checkSub()"/>
		</p>
		<br />
		<p>
			<h3>My stats</h3>
		...
		<script type="text/javaScript" src="http://users.encs.concordia.ca/~s_truo/A4/JSR/subtractionr.js"></script>
	</form>
</section>
