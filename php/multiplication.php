...
<?php 
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		$_SESSION['mA'] = $_POST['quiz'];
		$_SESSION['mS'] = $_POST['sco'];
...
<?php
$page_title="Quiz me: Multiplication";
// header
include("top.php");
?>
...
<section>
	...
	<form method="post" action="#">
		...
		<p>
			<input type = "button" value="Check" onclick = "checkMulti()"/>
		</p>
		<br />
		<p>
			<h3>My stats</h3>
		...
		<script type="text/javaScript" src="http://users.encs.concordia.ca/~s_truo/A4/JSR/multiplicationr.js"></script>
	</form>
</section>
